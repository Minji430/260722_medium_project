#!/usr/bin/env bash
# Codespaces 터미널에서 실행: bash setup.sh
# (파일 탐색기로 이 파일을 업로드한 뒤 터미널에서 실행하세요)
set -e
...
echo "생성 중: streamlit_app.py"
cat > "streamlit_app.py" << 'FILEEOF'
"""
1페이지 : 메인 페이지
웹페이지 소개 + 사용 방법 안내.
